...
-- policy.suffix для точечных доменов. Глобальный дефолтный резолвер задаётся
-- в kresd.conf, функция forward().

-- Пример: принудительно резолвить конкретные ваши домены через SkyDNS
